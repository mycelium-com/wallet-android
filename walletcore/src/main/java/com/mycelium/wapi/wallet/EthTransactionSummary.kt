...
class EthTransactionSummary(val sender: EthAddress, val receiver: EthAddress,
                            val nonce: BigInteger, val value: Value, val gasLimit: BigInteger, val gasUsed: BigInteger,
