...
class BitcoinUriTest {
    ...
    fun testMainnetBip21Request50BTCWithMessage() {
        // with only address
        testParse("bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?amount=50&label=Luke-Jr&message=Donation%20for%20project%20xyz", PN,
                BitcoinUri.from(AddressUtils.from(BitcoinMain.get(), "175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"), null, "Luke-Jr", null))
    }
