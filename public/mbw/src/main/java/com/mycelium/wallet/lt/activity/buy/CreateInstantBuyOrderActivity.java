...
public class CreateInstantBuyOrderActivity extends Activity implements NumberEntryListener {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      int mediumAmount = _sellOrderSearchItem.minimumFiat
            + (_sellOrderSearchItem.maximumFiat - _sellOrderSearchItem.minimumFiat) / 2;
      _tvAmount.setHint(Integer.toString(mediumAmount));
