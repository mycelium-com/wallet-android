...
public class TrezorAccountImportActivity extends TrezorAccountSelectorActivity {
   ...
   protected void setView() {
      ...
      findViewById(R.id.btNextAccount).setOnClickListener(new View.OnClickListener() {
         ...
         public void onClick(View view) {
            Utils.showSimpleMessageDialog(TrezorAccountImportActivity.this, getString(R.string.trezor_next_unused_account_info), new Runnable() {
               @Override
               public void run() {
