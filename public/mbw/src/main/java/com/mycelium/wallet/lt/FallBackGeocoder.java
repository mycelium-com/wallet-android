...
public class FallBackGeocoder extends Geocoder {
   ...
   private synchronized boolean fallback(){
      if (effectiveGeocoder instanceof GoogleMapsGeocoder){
         ...
         effectiveGeocoder = new BackendGeocoder(mbwManager.getLocalTraderManager());
         return true;
      }else{
         return false;
      }
   ...
   public String toString() {
      return "FallbackGeocoder(" + effectiveGeocoder.getClass().toString() + ")";
   }
