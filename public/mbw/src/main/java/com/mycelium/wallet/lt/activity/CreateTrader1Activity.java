...
public class CreateTrader1Activity extends Activity {
   ...
   private LocalTraderEventSubscriber ltSubscriber = new LocalTraderEventSubscriber(new Handler()) {
      ...
      public void onLtError(int errorCode) {
         Toast.makeText(CreateTrader1Activity.this, R.string.lt_error_api_occurred, Toast.LENGTH_LONG).show();
         finish();
      }

      @Override
      public boolean onNoLtConnection() {
         Utils.toastConnectionError(CreateTrader1Activity.this);
         finish();
         return true;
      };
      ...
      public boolean onLtNoTraderAccount() {
         ...
         CreateTrader2Activity.callMe(CreateTrader1Activity.this, privateKey);
         finish();
         return true;
      };
