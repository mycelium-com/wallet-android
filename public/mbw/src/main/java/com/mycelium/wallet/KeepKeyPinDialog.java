...
public class KeepKeyPinDialog extends PinDialog {
   ...
   public KeepKeyPinDialog(Context context, boolean hidden) {
      super(context, hidden, true);
   }

   @Override
   protected void loadLayout() {
      setContentView(R.layout.enter_keepkey_pin_dialog);
   }
   ...
   protected void initPinPad() {
      ...
      // reorder the Buttons for the keepkey PIN-entry (like a NUM-Pad)
