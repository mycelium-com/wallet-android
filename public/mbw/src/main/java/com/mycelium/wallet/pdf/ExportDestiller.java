...
public class ExportDestiller {
   ...
   public static class ExportProgressTracker {
      private static final int WATER_MARK_WORK = 10;
   ...
   private static double addRecord(OffsetWriter writer, boolean active, int entryNum, int totalEntries,
      ...
      writer.setTextColor(0, 0.5, 1);
      String title = (active ? "Active " : "Archive ") + entryNum + " of " + totalEntries;
