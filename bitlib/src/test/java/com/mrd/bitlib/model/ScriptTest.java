...
public class ScriptTest {
   ...
   private final String P2SH_OUTPUT_ADDRESS = "36f9dsGq4sw1xy44ZAuMQ1AAiAyHZxBagF";
   private final String SEGWIT_OUTPUT_ADDRESS = "n3REvJdQsv2yn1P1omycGBMhtYDnZjqX1m";
   private final String SEGWIT_P2SH_OUTPUT_ADDRESS = "2N2gnLss3NdVJmgruqzDRnEPHWtfLe1D8dF";
   ...
   @Test
   public void parseSegWitTransactionTest() throws Transaction.TransactionParsingException {
      Transaction transaction = Transaction.fromByteReader(new ByteReader(HexUtils.toBytes(SEGWIT_TRANSACTION)));
