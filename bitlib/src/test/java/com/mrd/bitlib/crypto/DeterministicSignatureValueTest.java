...
public class DeterministicSignatureValueTest {
   private class SignatureTestVector {
      ...
      SignatureTestVector(PrivateKey pk, byte[] message, BigInteger r, BigInteger s) {
         this.pk = pk;
      ...
      SignatureTestVector(String pk, String message, String r, String s) throws UnsupportedEncodingException {
         this(
   ...
   public void checkDeterministicSig() throws UnsupportedEncodingException {
      ...
      for (SignatureTestVector stv : new SignatureTestVector[]{
