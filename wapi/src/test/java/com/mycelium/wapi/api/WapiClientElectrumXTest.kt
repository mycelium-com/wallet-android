...
class WapiClientElectrumXTest {
    ...
    fun setup() {
        ...
        val wapiEndpoints: ServerEndpoints<HttpEndpoint> = mock(ServerEndpoints::class.java) as ServerEndpoints<HttpEndpoint>
    ...
    fun handleBroadcastResponseMissingInputs() {
        ...
        val response = listOf(RpcResponse.fromJson(BufferedReader(StringReader(json))))
