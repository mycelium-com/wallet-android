...
import com.mrd.mbw.AddressBookManager;
...
import com.mrd.mbw.SimpleGestureFilter;
import com.mrd.mbw.SimpleGestureFilter.SimpleGestureListener;
import com.mrd.mbw.Utils;
import com.mrd.mbw.activity.addressbook.AddressBookActivity;
import com.mrd.mbw.activity.export.ExportActivity;
...
public class RecordsActivity extends Activity implements SimpleGestureListener {
   ...
   public void onCreate(Bundle savedInstanceState) {
      ...
      OnClickListener menu = new AddClicked();

      findViewById(R.id.btAdd).setOnClickListener(menu);
   ...
   private static Record recordFromBitcoinAddressString(String string) {
      // Is it an address?
      Address address = stringToAddress(string);
      if (address != null) {
         // We have an address
   ...
   private static Address stringToAddress(String someString) {
   ...
   private void update() {
      ...
      findViewById(R.id.btAdd).setEnabled(_recordManager.numRecords() < BitcoinClientApi.MAXIMUM_ADDRESSES_PER_REQUEST);
