...
class WalletConfiguration(private val prefs: SharedPreferences,
    ...
    fun getSupportedERC20Tokens(): Map<String, ERC20Token> {
        ...
        val tokens = listOf(
            ...
            TokenData("Augur (REPv2)", "REP", 18, "0x221657776846890989a759ba2973e427dff5c9bb", "0xa9e5813de9de1732e52e1f2de416006cf7fe7320"),
            ...
            TokenData("Polygon", "MATIC", 18, "0x7D1AfA7B718fb893dB30A3aBc0Cfc608AaCfeBB0", "0xe2fbec39800e1e8fcef4225666e8c347f2585c76"),
            ...
            TokenData("Axie Infinity", "AXS", 18, "0xBB0E17EF65F82Ab018d8EDd776e8DD940327B28b"),
