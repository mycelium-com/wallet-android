...
public enum MinerFee {
   LOWPRIO("LOWPRIO", 20, R.string.miner_fee_lowprio_name, R.string.miner_fee_lowprio_desc, R.drawable.low_fee),
   ECONOMIC("ECONOMIC", 10, R.string.miner_fee_economic_name, R.string.miner_fee_economic_desc, R.drawable.eco_fee),
   NORMAL("NORMAL", 3, R.string.miner_fee_normal_name, R.string.miner_fee_normal_desc, R.drawable.normal_fee),
   PRIORITY("PRIORITY", 1, R.string.miner_fee_priority_name, R.string.miner_fee_priority_desc, R.drawable.high_fee),
...
//   private Bitcoins customFee = Bitcoins.nearestValue(0.001);
   ...
   MinerFee(String tag, int nBlocks, int idTag, int idLongDesc, int icon) {
      this.tag = tag;
