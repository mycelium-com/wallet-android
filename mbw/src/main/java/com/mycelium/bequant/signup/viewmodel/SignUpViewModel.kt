...
class SignUpViewModel(application: Application) : AndroidViewModel(application) {
    ...
    fun calculatePasswordLevel(password: String, passwordLevel: ProgressBar, passwordLevelLabel: TextView) {
        val strengh = Zxcvbn().measure(password)
        ...
        passwordLevel.progress = strengh.score * 30
        ...
        passwordLevelText.value = when (strengh.score) {
        ...
        passwordLevelLabel.setTextColor(resources.getColor(when (strengh.score) {
