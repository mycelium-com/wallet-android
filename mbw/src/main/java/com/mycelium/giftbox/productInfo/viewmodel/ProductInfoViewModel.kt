package com.mycelium.giftbox.productInfo.viewmodel
...
class ProductInfoViewModel(application: Application) : AndroidViewModel(application), AmountViewModel, DetailsViewModel {
