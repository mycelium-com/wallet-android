...
package com.mycelium.bitcoinj.crypto;
 ...
 * For more details on this, see https://github.com/bitcoinj/bitcoinj/blob/master/core/src/main/java/org/bitcoinj/protocols/payments/PaymentSession.java
 * and the article "Working with the payment protocol" on the bitcoinj website, or the Bitcoin developer guide.
 */
...
public class X509Utils {
    ...
    public static KeyStore loadKeyStore(String keystoreType, String keystorePassword, InputStream is)
