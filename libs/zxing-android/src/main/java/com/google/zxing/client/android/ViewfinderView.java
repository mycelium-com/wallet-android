...
public final class ViewfinderView extends View {
   ...
   public void onDraw(Canvas canvas) {
      ...
      if (resultBitmap != null) {
         ...
         // + 2, paint);
         // canvas.drawLine(frame.left, frame.top, frame.left + frame.width()/5,
         // frame.top, paint);
         int length = frame.width() / 5;
         int thickness = 3;
         int top = frame.top;
         int left = frame.left;
         ...
         // Top left horizontal
         canvas.drawRect(left, top, left + length, top + thickness, paint);
         // Top right horizontal
         canvas.drawRect(right - length, top, right, top + thickness, paint);
         // Bottom left horizontal
         canvas.drawRect(left, bottom - thickness, left + length, bottom, paint);
         // Bottom right horizontal
         canvas.drawRect(right - length, bottom - thickness, right, bottom, paint);
         ...
         canvas.drawRect(right - thickness, bottom - length, right, bottom - thickness, paint);
